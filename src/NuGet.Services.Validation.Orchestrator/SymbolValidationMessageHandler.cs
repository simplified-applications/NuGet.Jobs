...
namespace NuGet.Services.Validation.Orchestrator
{
    ...
    public class SymbolValidationMessageHandler : IMessageHandler<PackageValidationMessageData>
    {
        ...
        {
            if (validationSet.Completed)
            {
                _logger.LogInformation(
                    "The validation set for symbols package {PackageId} {PackageNormalizedVersion} {Key} with ID " +
                    "{ValidationSetId} is already completed. Discarding.",
                    validationSet.PackageId,
                    validationSet.PackageNormalizedVersion,
                    validationSet.PackageKey,
                    validationSet.ValidationTrackingId);
